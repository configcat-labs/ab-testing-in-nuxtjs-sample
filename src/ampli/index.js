 ...
 * To update run 'ampli pull online_store'
 *
 ...
 *
 * [Full Setup Instructions](https://data.amplitude.com/codedbychavez/codedbychavez/implementation/online_store)
 */
...
export const DefaultOptions = {
  plan: {
    ...
    branch: 'main',
    source: 'online_store',
    versionId: 'a30d273e-c5c4-40ab-b531-af9b1026c356'
  }
};
...
export class StoreVisitClick {
  constructor() {
    this.event_type = 'store_visit_click';
  }
}
...
export class Ampli {
   ...
   * store_visit_click
   *
   * [View in Tracking Plan](https://data.amplitude.com/codedbychavez/codedbychavez/events/main/latest/store_visit_click)
   *
   * Owner: Chavez Harris
   *
   ...
   * @param {MiddlewareExtra} [extra] Extra untyped parameters for use in middleware.
   */
  storeVisitClick(options, extra) {
    this.track(new StoreVisitClick(), options, extra);
  }
